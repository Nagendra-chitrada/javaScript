...
var _viewService = require("./view_service");
setTimeout(fetchdata((0, _config.SERVICE_URL)), 100000);
async function fetchdata(url) {
    let response = await fetch(url);
    let result = await response.json();
    console.log(result);
    (0, _viewService.viewservice)(result);
}

},{"./config":"k5Hzs","./view_service":"5F1Nm"}],"k5Hzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SERVICE_URL", ()=>SERVICE_URL);
const API_BASE_URL = `http://localhost:3000`;
const SERVICE_URL = `${API_BASE_URL}/services`;
const TESTMONIALS = `${API_BASE_URL}/Testmonials`;
...
},{}],"5F1Nm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "viewservice", ()=>viewservice);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eZyLq","dV6cC"], "dV6cC", "parcelRequire3463")

//# sourceMappingURL=bootstrap.e82f28a0.js.map
